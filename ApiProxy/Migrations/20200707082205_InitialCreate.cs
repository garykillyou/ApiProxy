    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApiKeyInfos", x => x.UserEmail);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AskApiKeys", x => x.UserEmail);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UrlReferences", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApiWithUrls", x => new { x.UserEmail, x.UrlReferenceID });
                    table.ForeignKey(
                        name: "FK_ApiWithUrls_UrlReferences_UrlReferenceID",
                        column: x => x.UrlReferenceID,
                        principalTable: "UrlReferences",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApiWithUrls_ApiKeyInfos_UserEmail",
                        column: x => x.UserEmail,
                        principalTable: "ApiKeyInfos",
                        principalColumn: "UserEmail",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApiWithUrls_UrlReferenceID",
                table: "ApiWithUrls",
                column: "UrlReferenceID");
